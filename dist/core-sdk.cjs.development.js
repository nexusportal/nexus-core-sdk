...
(function (ChainId) {
  ...
  ChainId[ChainId["XRPL"] = 1440000] = "XRPL";
...
var Songbird = /*#__PURE__*/function (_NativeCurrency) {
  function Songbird(chainId) {
    return _NativeCurrency.call(this, chainId, 18, 'ONE', 'Songbird') || this;
  }
  _inheritsLoose(Songbird, _NativeCurrency);
  Songbird.onChain = function onChain(chainId) {
    var _this$_cache$chainId;
    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Songbird(chainId);
  };
  var _proto = Songbird.prototype;
  _proto.equals = function equals(other) {
    return other.isNative && other.chainId === this.chainId;
  };
  return _createClass(Songbird, [{
    key: "wrapped",
    get: function get() {
      var wnative = WNATIVE[this.chainId];
      !!!wnative ?  invariant(false, 'WRAPPED')  : void 0;
...
var Apothem = /*#__PURE__*/function (_NativeCurrency) {
  ...
  Apothem.onChain = function onChain(chainId) {
    var _this$_cache$chainId;
    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Apothem(chainId);
  };
  var _proto = Apothem.prototype;
  _proto.equals = function equals(other) {
    return other.isNative && other.chainId === this.chainId;
  };
  return _createClass(Apothem, [{
    key: "wrapped",
    get: function get() {
      var wnative = WNATIVE[this.chainId];
      !!!wnative ?  invariant(false, 'WRAPPED')  : void 0;
...
var Xdc = /*#__PURE__*/function (_NativeCurrency) {
  ...
  Xdc.onChain = function onChain(chainId) {
    var _this$_cache$chainId;
    return (_this$_cache$chainId = this._cache[chainId]) != null ? _this$_cache$chainId : this._cache[chainId] = new Xdc(chainId);
  };
  var _proto = Xdc.prototype;
  _proto.equals = function equals(other) {
    return other.isNative && other.chainId === this.chainId;
  };
...
var toFixedRounding = (_toFixedRounding = {}, _toFixedRounding[exports.Rounding.ROUND_DOWN] = exports.Rounding.ROUND_DOWN, _toFixedRounding[exports.Rounding.ROUND_HALF_UP] = exports.Rounding.ROUND_HALF_UP, _toFixedRounding[exports.Rounding.ROUND_UP] = exports.Rounding.ROUND_UP, _toFixedRounding);
...
exports.MULTISTAKING_DISTRIBUTOR_ADDRESS = MULTISTAKING_DISTRIBUTOR_ADDRESS;
exports.Matic = Matic;
exports.MaxUint256 = MaxUint256;
exports.Movr = Movr;
exports.NATIVE = NATIVE;
exports.NEXU = NEXU;
exports.NEXUS_DIFFUSER_ADDRESS = NEXUS_DIFFUSER_ADDRESS;
exports.NEXUS_NFT_ADDRESS = NEXUS_NFT_ADDRESS;
exports.NEXUS_NFT_MULTISTAKING_ADDRESS = NEXUS_NFT_MULTISTAKING_ADDRESS;
exports.NEXUS_NFT_WEIGHT_ADDRESS = NEXUS_NFT_WEIGHT_ADDRESS;
exports.NEXU_DISTRIBUTOR_ADDRESS = NEXU_DISTRIBUTOR_ADDRESS;
